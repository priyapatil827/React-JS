  ...
  return (
    <div id="about" className="profile-section">
      <div className="info-section">
        ...
        <p className="p2">
          "Turning ideas into interactive experiences, I craft clean and
          responsive websites with modern technologies. Every line of code is a
          step toward creating seamless digital journeys."
        </p>
      </div>
      <img
